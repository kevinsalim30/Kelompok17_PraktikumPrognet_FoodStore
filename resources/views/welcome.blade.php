...
<div class="page-heading header-text">
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-left" style="margin-top: 100px!important">
                            ...
                            <div class="card mt-3" style="border-radius: 18px">
                                <div class="card-body">
                                    <div class="single-product mb-5">
                                        @php $product_images =
                                        \App\Product_Image::where('product_id','=',$item->id)->get();
                                        @endphp
                                        <div class="product-img rounded-xll">
                                            @foreach ($product_images as $image)
                                            <a href="{{route('detail_product',['id'=>$item->id])}}"
                                                style="color: inherit;">
                                                <img src="  {{ asset('storage/public_html/gambarproduct/'.$image->image_name) }}"
                                        ...
                                        <div class="product-caption">
                                            ...
                                            <h4><a href="" style="color: inherit;">{{$item->product_name}}</a></h4>
                                            <div class="price">
                                                <ul>
                                            ...
                                            <div class="buy">
                                                <a href="{{route('detail_product',['id'=>$item->id])}}"
                                                    class="btn btn-primary" style="color: white;">Pesan</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
