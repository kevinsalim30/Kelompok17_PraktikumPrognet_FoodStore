                ...
                <div class="auth-box ">
                    <div class="left" style="margin-left: 80px">
                        <div class="content" style="width: 98%">
                            ...
                            <form method="POST" action="{{ route('admin.login.submit') }}" class="mx-auto text-center align-center">
                                @csrf

                                <div class="form-group row">
                                    <label for="email"
                                        class="col-md-12 col-form-label label-text text-left">{{ __('Username') }}</label>

                                    <div class="col-md-10">
                                        <input id="email" type="text"
                                            class="form-control input-login @error('username') is-invalid @enderror"
