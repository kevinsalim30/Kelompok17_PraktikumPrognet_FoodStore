          ...
          <div class="row">
                      ...
                      <div class="row">
                            <div class="col-md-12">
                                <div class="form-group bmd-form-group">
                                    <label class="bmd-label-floating">Nama Makanan</label>
            ...
            {{-- producImage --}}
             <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Gambar Makanan</h4>
                </div>
                <div class="card-body">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Jenis Makanan</h4>
                    ...
                    <form action="{{route('product.add_cat',['id'=>$product->id])}}" method="post"  class="form">
                      ...
                      <div class="form-group">
                        <select  class="form-control" name="product_category" data-style=" btn btn-link">
                          ...
                          @else
                               <option selected disabled>-- Jenis Makanan --</option>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Review Makanan</h4>
                  <p class="card-category"> </p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
