            ...
            <div class="col-9">
                <form action="{{ route('order.payment') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="callback-form "
                        style="margin-top: 25px; padding-top: 45px; padding-bottom: 0;">
                                                ...
                                                <div class="row">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="col-md-9">
                                                                    <em>{{ $order_detail->product->product_name }}</em>
                                                                    </h4>
                                                                </td>
                        ...
                        <div class="w-md-80 w-lg-60 text-center mx-md-auto pb-3">
                            <div class="mb-5">
                                <svg xmlns="http://www.w3.org/2000/svg" height="75" fill="currentColor"
