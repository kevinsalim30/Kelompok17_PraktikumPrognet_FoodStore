...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="/admin" style="font-weight: bold; font-size: 18px;color: black">Food Store</a>
			</div>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="/courier" class="{{ Request::url() == url('/courier') ? 'active' : '' }}"><i class="lnr lnr-code"></i> <span>Kurir</span></a></li>
						<li><a href="/products" class="{{ Request::url() == url('/products') ? 'active' : '' }}"><i class="lnr lnr-chart-bars"></i> <span>Makanan</span></a></li>
						<li><a href="/categories" class="{{ Request::url() == url('/categories') ? 'active' : '' }}"><i class="lnr lnr-cog"></i> <span>Jenis Makanan</span></a></li>
						<li><a href="/transactions" class="{{ Request::url() == url('/transactions') ? 'active' : '' }}"><i class="fa fa-shopping-cart"></i> <span>Transaksi</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
								...
								<div class="col-md-4">
									<div class="metric">
										...
										<p>
											...
											<span class="title">Pendapatan Tahunan</span>
										</p>
									</div>
								</div>
                                <div class="col-md-4">
                                     <div class="metric">
                                        <span class="icon"><i class="fa fa-cart-plus" aria-hidden="true"></i>
                                            ...
                                            <p>
                                                ...
                                                <span class="title">Pendapatan Bulanan</span>
                                            </p>
                                    </div>
                                </div>
                                <div class="col-md-4">
		...
		<footer>
			<div class="container-fluid">
				<p class="copyright">&copy; 2021 <a href="https://www.themeineed.com" target="_blank">Kelompok 17</a>. All Rights Reserved.</p>
			</div>
		</footer>
	</div>
	<!-- END WRAPPER -->
